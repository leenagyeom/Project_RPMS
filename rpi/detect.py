...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'car_plate_yolov5s_best.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default=0, help='file/dir/URL/glob, 0 for webcam')
    parser.add_argument('--data', type=str, default=ROOT / 'data/detect_data.yaml', help='(optional) dataset.yaml path')
    ...
    parser.add_argument('--view-img', default = ROOT / 'runs/detect', action='store_true', help='show results')
    ...
    parser.add_argument('--save-crop', default = ROOT / 'runs/detect', action='store_true', help='save cropped prediction boxes')
